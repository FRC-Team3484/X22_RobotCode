...
/* ============================================================================== */
	...
	public:
		...
		~SC_SBItem() { if(_entry != nullptr) { delete this->_entry; } }

		void SetProperties(wpi::StringMap<nt::Value> Props)
		{
			this->_props = Props;
			this->_widget = this->_widget->WithProperties(Props);
		}

		bool GetBool(bool DefaultValue = false) { return (_entry != nullptr) ? this->_entry->GetBoolean(DefaultValue) : false; }

		double GetNumber(double DefaultValue = 0.0) { return (_entry != nullptr) ? this->_entry->GetDouble(DefaultValue) : 0.0; }

		void SetBool(bool value) { if(_entry != nullptr) { this->_entry->SetBoolean(value); } }

		void SetNumber(double value) { if(_entry != nullptr) { this->_entry->SetDouble(value); } }
				
		void SetText(std::string value) { if(_entry != nullptr) { this->_entry->SetString(value); } }
...
/* ============================================================================== */
	...
	public:
		...
		SC::SC_SBItem<bool>* AddBoolean(std::string Name, wpi::StringMap<nt::Value> Props) { return new SC::SC_SBItem<bool>(this->_tabName, Name, frc::BuiltInWidgets::kBooleanBox, Props); }
		...
		SC::SC_SBItem<double>* AddNumBar(std::string Name, wpi::StringMap<nt::Value> Props, double DefaultVal = 0.0) { return new SC::SC_SBItem<double>(this->_tabName, Name, frc::BuiltInWidgets::kNumberBar, Props, DefaultVal); }
