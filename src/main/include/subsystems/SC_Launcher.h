#ifndef SC_Launcher_h
#define SC_Launcher_h
...
public:
	...
	/**
	 *@brief Returns whether the turret's minimum travel limit switch is pressed. Return false if the input is null. 
	 */
	bool IsTurretAtMin();

	/**
	 * @brief Returns whether the turret's maxium travel limit switch is pressed. Returns false if the input is null.
	 */
	bool IsTurretAtMax();
